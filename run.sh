...
#CUDA_VISIBLE_DEVICES=5 python train.py -s  real_data -m output/real_data --checkpoint_iterations 7000 30000 --iterations 30_000 #--start_checkpoint /hdd2/sseth/codes/gaussian-splatting/output/real_data_shirt/chkpnt30000.pth
